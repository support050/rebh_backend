...
PARAM_MAPPING = {
    ...
    'gross premiums/ contributions written': ('IS-010', 1),
    'net premiums/ contributions written': ('IS-010', 1),
    'net premiums/ contributions earned': ('IS-010', 1),
    'net claims/ benefits incurred': ('IS-020', -1),
    'net claims/ benefits paid': ('IS-020', -1),
    'shareholders appropriation of surplus/ deficit from insurance/ takaful operations': ('IS-060', 1),
    'shareholders appropriation of surplus from insurance operations': ('IS-060', 1),
    'commission/ profit on deposits': ('IS-090', 1),
    'income (loss) from continuing operations before zakat and tax': ('IS-110', 1),
    'profit (loss) attributable to saudi shareholders in company': ('IS-150', 1),
    'profit (loss), attributable to saudi shareholders in company': ('IS-150', 1),
    'profit (loss) attributable to saudi shareholders': ('IS-150', 1),
